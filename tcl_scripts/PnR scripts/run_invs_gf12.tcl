...
#if {![file exists ${outputDir}/Route]} {
#    exec mkdir ${outputDir}/Route
#    #exec mkdir ${outputDir}/Route/timing
#}
...
#summaryReport -noHtml -outfile ${outputDir}/Route/post_opt_route_summary.rpt
#report_power -outfile ${outputDir}/Route/power_routeOpt.rpt
#report_timing -path_type full_clock > ${outputDir}/Route/timing_routeOpt.rpt
#report_power -leakage -outfile ${outputDir}/Route/leakage_power_routeOpt.rpt
#report_power -hierarchy all -outfile ${outputDir}/Route/power_hierarchy_routeOpt.rpt
#report_area > ${outputDir}/Route/area_routeOpt.rpt
#report_instance_power *reg* -file ${outputDir}/Route/reg_power_routeOpt.rpt
#report_cell_area  -file ${outputDir}/Route/cell_area_routeOpt.rpt
